# Winnipeg Blue Bombers Theme for Oh My Zsh using Nerd Fonts

# Colors (using Winnipeg Blue Bombers palette)
PRIMARY='25'  # #1D3D8A (Blue)
SECONDARY='214'  # #FFB81C (Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='160'  # #D70000 (Red for alerts)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON=""    # Nerd Font code for fighter jet icon
...
# Context: user with fighter jet icon
prompt_context() {
