# Hamilton Tiger-Cats Theme for Oh My Zsh using Nerd Fonts

# Colors (using Hamilton Tiger-Cats palette)
...
# Nerd Font Symbols
TEAM_ICON="\U000f011b"    # Nerd Font code for cat icon
