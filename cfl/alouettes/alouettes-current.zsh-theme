# Montreal Alouettes Theme for Oh My Zsh using Nerd Fonts

# Colors (using Montreal Alouettes palette)
PRIMARY='17'  # #0F2D50 (Navy)
SECONDARY='248'  # #A2AAAD (Silver)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='160'  # #B7202E (Red for alerts)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\U000f15c6"    # Nerd Font code for bird icon
