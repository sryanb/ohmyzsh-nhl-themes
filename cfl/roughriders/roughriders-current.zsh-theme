# Saskatchewan Roughriders Theme for Oh My Zsh using Nerd Fonts

# Colors (using Saskatchewan Roughriders palette)
PRIMARY='29'  # #006341 (Green)
SECONDARY='15'  # #FFFFFF (White)
TERTIARY='0'  # #000000 (Black)
ACCENT='248'  # #A2AAAD (Silver)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\U000f0073"    # Nerd Font code for barley icon
