# Calgary Stampeders Theme for Oh My Zsh using Nerd Fonts

# Colors (using Calgary Stampeders palette)
...
# Nerd Font Symbols
TEAM_ICON="\U000f15bf"    # Nerd Font code for horse icon
