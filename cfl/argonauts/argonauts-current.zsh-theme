# Toronto Argonauts Theme for Oh My Zsh using Nerd Fonts

# Colors (using Toronto Argonauts palette)
PRIMARY='17'  # #002B5C (Oxford Blue)
SECONDARY='74'  # #5B9BD5 (Cambridge Blue)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='160'  # #D70000 (Red for alerts)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\U000f0ec8"    # Nerd Font code for sail boat icon
...
# Context: user with sail boat icon
prompt_context() {
