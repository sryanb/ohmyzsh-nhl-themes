# Ottawa Redblacks Theme for Oh My Zsh using Nerd Fonts

# Colors (using Ottawa Redblacks palette)
PRIMARY='124'  # #A6192E (Red)
...
# Nerd Font Symbols
TEAM_ICON="\U000f0e61"    # Nerd Font code for saw blade icon
...
# Context: user with saw blade icon
prompt_context() {
