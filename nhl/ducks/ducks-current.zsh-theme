# Anaheim Ducks Theme for Oh My Zsh using Nerd Fonts

# Colors (using Anaheim Ducks palette)
PRIMARY='0'  # #000000 (Black)
SECONDARY='208'  # #F47A38 (Orange)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='179'  # #B9975B (Gold)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf1b0"    # Nerd Font code for webbed foot (paw) icon
...
# Context: user with webbed foot icon
prompt_context() {
