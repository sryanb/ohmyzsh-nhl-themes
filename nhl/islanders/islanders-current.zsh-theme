# New York Islanders Theme for Oh My Zsh using Nerd Fonts

# Colors (using New York Islanders palette)
PRIMARY='25'  # #00539B (Royal Blue)
SECONDARY='208'  # #F47D30 (Orange)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='0'  # #000000 (Black)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf13d"    # Nerd Font code for anchor icon
