# Pittsburgh Penguins Theme for Oh My Zsh using Nerd Fonts

# Colors (using Pittsburgh Penguins palette)
PRIMARY='0'  # #000000 (Black)
SECONDARY='220'  # #FCB514 (Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='94'  # #875F00 (Dark Gold)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf17c"    # Nerd Font code for penguin icon
...
# Context: user with penguin icon
prompt_context() {
