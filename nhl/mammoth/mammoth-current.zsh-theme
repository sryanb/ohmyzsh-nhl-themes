# Utah Mammoth Theme for Oh My Zsh using Nerd Fonts

# Colors (using Utah Mammoth palette)
PRIMARY='0'  # #000000 (Rock Black)
SECONDARY='75'  # #6CACE4 (Mountain Blue)
TERTIARY='15'  # #FFFFFF (Salt White)
ACCENT='236'  # #303030 (Dark Grey)
RESET='%f'
