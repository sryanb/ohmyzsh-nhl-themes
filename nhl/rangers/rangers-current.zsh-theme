# New York Rangers Theme for Oh My Zsh using Nerd Fonts

# Colors (using New York Rangers palette)
PRIMARY='25'  # #0038A8 (Blue)
...
# Nerd Font Symbols
TEAM_ICON="\uf132"    # Nerd Font code for shield icon
