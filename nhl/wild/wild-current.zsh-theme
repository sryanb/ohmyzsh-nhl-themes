# Minnesota Wild Theme for Oh My Zsh using Nerd Fonts

# Colors (using Minnesota Wild palette)
PRIMARY='22'  # #154734 (Forest Green)
SECONDARY='178'  # #EAAA00 (Wheat Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='124'  # #A6192E (Red)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf1bb"    # Nerd Font code for tree icon
