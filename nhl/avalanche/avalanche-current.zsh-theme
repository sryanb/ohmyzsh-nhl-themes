# Colorado Avalanche Theme for Oh My Zsh using Nerd Fonts

# Colors (using Colorado Avalanche palette)
PRIMARY='88'  # #6F263D (Burgundy)
SECONDARY='248'  # #A2AAAD (Silver)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='25'  # #236192 (Steel Blue)
RESET='%f'
...
# Context: user with snowflake icon
prompt_context() {
