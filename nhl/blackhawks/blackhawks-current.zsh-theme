# Chicago Blackhawks Theme for Oh My Zsh using Nerd Fonts

# Colors (using Chicago Blackhawks palette)
PRIMARY='160'  # #CF0A2C (Red)
SECONDARY='220'  # #FFD100 (Gold)
...
# Context: user with feather icon
prompt_context() {
