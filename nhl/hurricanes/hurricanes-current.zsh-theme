# Carolina Hurricanes Theme for Oh My Zsh using Nerd Fonts

# Colors (using Carolina Hurricanes palette)
PRIMARY='160'  # #CC0000 (Red)
...
# Nerd Font Symbols
TEAM_ICON="\uf021"    # Nerd Font code for hurricane icon
...
# Context: user with hurricane icon
prompt_context() {
