# Columbus Blue Jackets Theme for Oh My Zsh using Nerd Fonts

# Colors (using Columbus Blue Jackets palette)
PRIMARY='17'  # #002654 (Navy)
SECONDARY='248'  # #A4A9AD (Silver)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='160'  # #CE1126 (Red)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf024"    # Nerd Font code for flag icon
