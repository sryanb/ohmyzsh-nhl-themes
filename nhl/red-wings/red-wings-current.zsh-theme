# Detroit Red Wings Theme for Oh My Zsh using Nerd Fonts

# Colors (using Detroit Red Wings palette)
...
# Nerd Font Symbols
TEAM_ICON="\uf013"    # Nerd Font code for wheel icon
