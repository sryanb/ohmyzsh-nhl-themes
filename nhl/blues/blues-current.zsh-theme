# St. Louis Blues Theme for Oh My Zsh using Nerd Fonts

# Colors (using St. Louis Blues palette)
PRIMARY='18'  # #002F87 (Blue)
SECONDARY='220'  # #FCB514 (Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='17'  # #041E42 (Navy)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf001"    # Nerd Font code for music note icon
...
# Context: user with music note icon
prompt_context() {
