# Florida Panthers Theme for Oh My Zsh using Nerd Fonts

# Colors (using Florida Panthers palette)
PRIMARY='160'  # #C8102E (Red)
SECONDARY='179'  # #B9975B (Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='17'  # #041E42 (Navy)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf185"    # Nerd Font code for sun icon
