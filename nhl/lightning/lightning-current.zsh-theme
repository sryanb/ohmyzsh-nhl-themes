# Tampa Bay Lightning Theme for Oh My Zsh using Nerd Fonts

# Colors (using Tampa Bay Lightning palette)
PRIMARY='18'  # #002868 (Blue)
...
# Nerd Font Symbols
TEAM_ICON="\uf0e7"    # Nerd Font code for lightning bolt icon
...
# Context: user with lightning bolt icon
prompt_context() {
