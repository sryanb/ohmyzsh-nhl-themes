# Toronto Maple Leafs Theme for Oh My Zsh using Nerd Fonts

# Colors (using Toronto Maple Leafs palette)
PRIMARY='17'  # #00205B (Blue)
...
# Nerd Font Symbols
TEAM_ICON="\uf06c"    # Nerd Font code for leaf icon
