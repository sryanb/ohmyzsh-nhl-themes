# Dallas Stars Theme for Oh My Zsh using Nerd Fonts

# Colors (using Dallas Stars palette)
PRIMARY='29'  # #006847 (Victory Green)
SECONDARY='245'  # #8F8F8C (Silver)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='0'  # #000000 (Black)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf005"    # Nerd Font code for star icon
