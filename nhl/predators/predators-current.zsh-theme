# Nashville Predators Theme for Oh My Zsh using Nerd Fonts

# Colors (using Nashville Predators palette)
PRIMARY='220'  # #FFB81C (Gold)
SECONDARY='17'  # #041E42 (Navy)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='17'  # #041E42 (Navy)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\U000f08c3"    # Nerd Font code for tooth icon
