# New Jersey Devils Theme for Oh My Zsh using Nerd Fonts

# Colors (using New Jersey Devils palette)
PRIMARY='160'  # #CE1126 (Red)
SECONDARY='0'  # #000000 (Black)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='52'  # #5F0000 (Dark Red)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf06d"    # Nerd Font code for fire icon
