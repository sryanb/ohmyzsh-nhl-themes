# Ottawa Senators Theme for Oh My Zsh using Nerd Fonts

# Colors (using Ottawa Senators palette)
PRIMARY='0'  # #000000 (Black)
SECONDARY='178'  # #C69214 (Gold)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='160'  # #C8102E (Red)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf0e3"    # Nerd Font code for gavel icon
