# Winnipeg Jets Theme for Oh My Zsh using Nerd Fonts

# Colors (using Winnipeg Jets palette)
PRIMARY='17'  # #041E42 (Navy)
SECONDARY='250'  # #7B303E (Silver)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='124'  # #AC162C (Red)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf072"    # Nerd Font code for plane icon
