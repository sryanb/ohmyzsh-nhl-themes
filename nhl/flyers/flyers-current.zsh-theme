# Philadelphia Flyers Theme for Oh My Zsh using Nerd Fonts

# Colors (using Philadelphia Flyers palette)
PRIMARY='0'  # #000000 (Black)
SECONDARY='202'  # #F74902 (Orange)
TERTIARY='15'  # #FFFFFF (White)
ACCENT='202'  # #F74902 (Orange)
RESET='%f'

# Nerd Font Symbols
TEAM_ICON="\uf1d8"    # Nerd Font code for paper plane icon
...
# Context: user with paper plane icon
prompt_context() {
