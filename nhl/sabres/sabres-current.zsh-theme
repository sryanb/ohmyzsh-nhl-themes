# Buffalo Sabres Theme for Oh My Zsh using Nerd Fonts

# Colors (using Buffalo Sabres palette)
PRIMARY='18'  # #003087 (Royal Blue)
...
# Context: user with crossed swords icon
prompt_context() {
