# Washington Capitals Theme for Oh My Zsh using Nerd Fonts

# Colors (using Washington Capitals palette)
PRIMARY='160'  # #C8102E (Red)
...
# Nerd Font Symbols
TEAM_ICON="\uf19c"    # Nerd Font code for capitol icon
...
# Context: user with capitol icon
prompt_context() {
